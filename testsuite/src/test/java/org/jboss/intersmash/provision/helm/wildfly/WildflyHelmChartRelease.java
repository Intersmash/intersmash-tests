...
public interface WildflyHelmChartRelease extends HelmChartRelease {
	...
	default String getJdk17BuilderImage(){return null;};

	default void setJdk17BuilderImage(String jdk17BuilderImage){};

	default WildflyHelmChartRelease withJdk17BuilderImage(String jdk17BuilderImage){return null;};

	default String getJdk17RuntimeImage(){return null;};

	default void setJdk17RuntimeImage(String jdk17RuntimeImage){};

	default WildflyHelmChartRelease withJdk17RuntimeImage(String jdk17RuntimeImage){return null;};




	default String getJdk21BuilderImage(){return null;};

	default void setJdk21BuilderImage(String jdk21BuilderImage){};

	default WildflyHelmChartRelease withJdk21BuilderImage(String jdk21BuilderImage){return null;};

	default String getJdk21RuntimeImage(){return null;};

	default void setJdk21RuntimeImage(String jdk21RuntimeImage){};

	default WildflyHelmChartRelease withJdk21RuntimeImage(String jdk21RuntimeImage){return null;};



	default String getJdk25BuilderImage(){return null;};

	default void setJdk25BuilderImage(String jdk25BuilderImage){};

	default WildflyHelmChartRelease withJdk25BuilderImage(String jdk25BuilderImage){return null;};

	default String getJdk25RuntimeImage(){return null;};

	default void setJdk25RuntimeImage(String jdk25RuntimeImage){};

	default WildflyHelmChartRelease withJdk25RuntimeImage(String jdk25RuntimeImage){return null;};
