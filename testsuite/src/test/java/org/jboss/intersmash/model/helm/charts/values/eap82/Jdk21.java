...
public class Jdk21 {
    ...
    /**
     * EAP S2I Builder image for JDK 21
     * 
     */
    @JsonProperty("builderImage")
    @JsonPropertyDescription("EAP S2I Builder image for JDK 21")
    private String builderImage;
    /**
     * EAP S2I Runtime image for JDK 21
     * 
     */
    @JsonProperty("runtimeImage")
    @JsonPropertyDescription("EAP S2I Runtime image for JDK 21")
    ...
    public Jdk21 withBuilderImage(String builderImage) {
        this.builderImage = builderImage;
        return this;
    }
    ...
    public Jdk21 withRuntimeImage(String runtimeImage) {
        this.runtimeImage = runtimeImage;
        return this;
    }
    ...
    public Jdk21 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Jdk21 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Jdk21) == false) {
            return false;
        }
        Jdk21 rhs = ((Jdk21) other);
