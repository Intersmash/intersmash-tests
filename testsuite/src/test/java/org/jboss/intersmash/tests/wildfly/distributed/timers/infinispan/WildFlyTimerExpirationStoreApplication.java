...
public class WildFlyTimerExpirationStoreApplication
	...
	public WildFlyTimerExpirationStoreApplication() {
		...
		environmentVariables.add(
				new EnvVarBuilder()
						.withName("POSTGRESQL_DRIVER_VERSION")
						.withValue(System.getProperty("org.jboss.eap.datasources.postgresql.driver.version"))
						.build());
		// doesn't have to form a cluster with the other application in the test
		environmentVariables.add(
				new EnvVarBuilder()
						.withName("JBOSS_DEFAULT_MULTICAST_ADDRESS")
						.withValue("230.0.0.5")
						.build());
