...
public class WildflyS2iPerConnectorSecuredKafkaHelmApplication
	 ...
	 *   <li>Maven build arguments and environment variables, including {@code -Ps2i} to activate the S2I profile</li>
	...
	private HelmChartRelease loadRelease(final WildflyHelmChartRelease release) throws IOException {
		...
		// activate the s2i profile to disable bootable JAR packaging; target the specific module
		mavenAdditionalArgs = mavenAdditionalArgs.concat(" -Ps2i -Dmaven.source.skip -pl " + APP_MODULE_DIRECTORY + " -am ");
