 ...
 * deployment.
 *
 *  You can configure the elytron-oidc-client layer in three different ways:
 * <ul>
 *     <li>Adding an oidc.json into your deployment.</li>
 *     <li>Running a CLI script to configure the elytron-oidc-client layer.</li>
 *     <li>Defining environment variables to configure an elytron-oidc-client layer on start of JBoss EAP server on OpenShift.</li>
 * </ul>
 *
...
public class WildflyBootableJarWithElytronOidcClientApplication
	...
	private static final String APP_MODULE_DIRECTORY = "wildfly/elytron-oidc-client-keycloak-bootable-jar";
	...
	/**
	 * Constructs a new WildFly/JBoss EAP application configured with Keycloak OIDC adapter.
	 * <p>
	...
	private HelmChartRelease loadRelease(final WildflyHelmChartRelease release) throws IOException {
		...
		buildEnvironmentVariables.put("SSO_OIDC_KEYCLOAK_REALM",
				BasicKeycloakOperatorOidcHttpsApplication.REALM_NAME);
		...
		deploymentEnvironmentVariables.put("SSO_OIDC_KEYCLOAK_URL",
				String.format("https://%s", BasicKeycloakOperatorOidcHttpsApplication.getRoute()));
		deploymentEnvironmentVariables.put("SSO_OIDC_CLIENT_ID",
				BasicKeycloakOperatorOidcHttpsApplication.SSO_OIDC_CLIENT_ID);
		deploymentEnvironmentVariables.put("SSO_OIDC_CLIENT_SECRET",
				BasicKeycloakOperatorOidcHttpsApplication.SSO_OIDC_CLIENT_SECRET);
